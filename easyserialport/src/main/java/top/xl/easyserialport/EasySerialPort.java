...
public class EasySerialPort {
    ...
    private EasySerialPort(String port, int baudRate, OnStatesChangeListener onStatesChangeListener, OnSerialPortReceivedListener listener) {
        this.port = port;
    ...
    public static class Builder {
        ...
        public EasySerialPort build() throws Exception {
            ...
            return new EasySerialPort(port, baudRate,onStatesChangeListener, onSerialPortReceivedListener);
        }
    }

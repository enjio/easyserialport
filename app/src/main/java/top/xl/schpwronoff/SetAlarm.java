...
public class SetAlarm extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mId = getIntent().getIntExtra(Alarms.ALARM_ID, 0);
          Log.d("@M_" + TAG, "onCreate " + "bundle extra is " + mId);
        ...
        Log.d("@M_" + TAG, "In SetAlarm, alarm id = " + mId);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mTimePref) {
        	 Log.d("@M_" + TAG, "showDialog(DIALOG_TIMEPICKER)");
    ...
    public Dialog onCreateDialog(int id) {
        ...
        case DIALOG_TIMEPICKER:
        	 Log.d("@M_" + TAG, "onCreateDialog(DIALOG_TIMEPICKER)");
    ...
    static void popAlarmSetToast(Context context, int hour, int minute, Alarm.DaysOfWeek daysOfWeek, int mId) {
        ...
        Log.d("@M_" + TAG, "toast text: " + toastText);
    ...
    @Override
     public void onConfigurationChanged(Configuration newConfig) {
       ...
       Log.d("@M_" + TAG, "onConfigurationChanged: " + newConfig.orientation + ",remove timer picker dialog");
